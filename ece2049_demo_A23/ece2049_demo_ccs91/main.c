...
void main(void)
{
    ...
    Graphics_drawStringCentered(&g_sContext, ryan, AUTO_STRING_LENGTH, 48, 15, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, "and", AUTO_STRING_LENGTH, 48, 25, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, "Christian", AUTO_STRING_LENGTH, 48, 35, TRANSPARENT_TEXT);
    ...
    while (1)    // Forever loop
    {
        ...
        if (currKey)
        {
            ...
            Graphics_drawStringCentered(&g_sContext, dispThree, dispSz, 30, 90, OPAQUE_TEXT);
